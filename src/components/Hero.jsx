...
const Hero = () => {
    return (
        <section className='min-h-screen relative flex'>
            ...
            <article className='grow flex flex-col items-center justify-center px-5 pb-10 gap-6 radial-gradient sm:radial-gradient-sm sm:pb-0 md:pb-10 md:radial-gradient lg:pt-[12vh] lg:normal-gradient'>
                <motion.img
                    src={banner}
                    ...
                    className="w-[85%] sm:w-[70%] md:w-[75%] lg:w-[45%]"
                />
