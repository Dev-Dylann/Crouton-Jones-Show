...
const Roadmap = () => {
    return (
        <section className="py-16 px-5 flex flex-col gap-4 bg-[url('./background/background_faded.webp')] bg-cover bg-center bg-fixed md:py-28 md:px-8">
            <motion.h2
            ...
            <article className="flex flex-col gap-28 relative my-5 md:gap-36">
                ...
                <motion.div
                    ...
                    transition={{ type: 'tween', duration: 0.5 }}
                    viewport={{ once: true }}
                    className="bg-white shadow-lg flex flex-col gap-2 shadow-textColor/50 rounded-lg p-5 z-[2] md:p-8 md:gap-4">
